...
public class CabinetEditor extends DTOEditor<CabinetDTO> implements ClickHandler {
    ...
    public OrganizationEditor organization;
    ...
    public CabinetEditor(AsyncCallback<CabinetDTO> callback, AsyncCallback<CabinetDTO> deleteCallback) {
        ...
        Label labelNumber = new Label("№ кабинета: ");
        Label labelSquare = new Label("Площадь: ");
        Label labelType = new Label("Тип: ");
        Label labelOrganization = new Label("Организация");
        ...
        organization = new OrganizationEditor();
        add(labelNumber);
        add(number);
        add(labelSquare);
        add(square);
